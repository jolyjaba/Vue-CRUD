<template>
  <div class="modal-block" v-if="isModalOpen">
    <div :class="['modal-block__message', 'add-form']">
      ...
      <div class="modal-block__text">
        <slot name="message">Modal message</slot>
      </div>
      <div v-if="itemForm" class="modal-block__form">
      ...
      <div class="modal-block__buttons">
        ...
        <div class="modal-block__confirm" @click="onConfirm">
          <slot name="button">Confirm Button</slot>
        </div>
      </div>
    </div>
